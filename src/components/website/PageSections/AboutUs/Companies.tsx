    ...
    <section  className='container mx-auto'>
        <div className="flex flex-col justify-center items-center py-10">
            ...
            <div className="flex justify-between items-center gap-30 flex-wrap">
                ...
                <Image src="/images/catalog-logo.png" alt="Company 4" width={150} height={50} className="mx-4"/>
                <Image src="/images/quotient-logo.png" alt="Company 4" width={150} height={50} className="mx-4"/>
            </div>
        </div>
    </section>
  )
